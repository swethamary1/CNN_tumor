...
image_dir = r"C:/Users/Samta/Desktop/Tensor Flow/tumordata"
...
plt.savefig(r"C:\Users\Samta\Desktop\Tensor Flow\deep-learning\CNN\tumor_detection\results1\tumor_sample_accuracy_plot.png")
...
plt.savefig(r"C:\Users\Samta\Desktop\Tensor Flow\deep-learning\CNN\tumor_detection\results1/tumor_sample_loss_plot.png")
...
model.save(r"C:\Users\Samta\Desktop\Tensor Flow\deep-learning\CNN\tumor_detection\results1\model/cnn_tumor.h5")
...
make_prediction(cv2.imread(r"C:\Users\Samta\Desktop\Tensor Flow/tumordata\yes\y1.jpg"),model)
print("--------------------------------------\n")
make_prediction(cv2.imread(r"C:\Users\Samta\Desktop\Tensor Flow/tumordata/no/no1.jpg"),model)
print("--------------------------------------\n")
